...
import "./SchedulePageMapCopy.css";
...
function SchedulePageMapCopy(props) {
  /////////////////////////////MAP STUFF//////////////////////////////////////
  //Map
            ...
            <form style={{}} onSubmit={handleSubmit}>
              ...
              <Group mb={10}>
                <Input
                  ...
                  disabled={keepStart}
                  leftSection={
                    <IconMapPin size={"20"} color="green"></IconMapPin>
                  }
              ...
              <Group mb={10}>
                <Input
                  leftSection={
                    <IconMapPin size={"20"} color="red"></IconMapPin>
                  }
                  required
                  w={350}
...
export default SchedulePageMapCopy;
